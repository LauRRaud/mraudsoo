            ...
            {teenused.map((teenus) => (
              <li key={teenus.slug}>
                <Link
                  ...
                  className="group -mx-6 grid grid-cols-1 gap-x-12 gap-y-4 border-t border-gold/25 px-6 py-10 transition-colors duration-300 hover:bg-bone sm:grid-cols-[1.05fr_1fr] sm:py-12 lg:-mx-12 lg:px-12"
                >
                  <div>
